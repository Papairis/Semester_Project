...
int main() {
	...
	int current_year[1]            ={2022};
	int exp_date[10] 		= {2022,2023,2024,2024,2024,2024,2024,2024,2025,2025};
	int pro_date [10]		= {2021,2022,2023,2023,2023,2023,2023,2023,2023,2023};
	string product[10]	 	= {"Cerelac","Banku","Milo","Rice","Nido","Magarine","Yam-chips","Milk","Coca-cola","Oil"};
